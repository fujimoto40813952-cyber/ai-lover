...
export default function TokushohoPage() {
  return (
    <LegalShell title="特定商取引法に基づく表記" updatedAt="2026年6月17日">
      ...
      <div className="mt-4">
        <Row label="販売事業者">【要記入：事業者名／屋号】</Row>
        <Row label="運営統括責任者">【要記入：氏名】</Row>
        <Row label="所在地">【要記入：住所】（※請求があった場合は遅滞なく開示します）</Row>
        <Row label="電話番号">【要記入：電話番号】（※請求があった場合は遅滞なく開示します）</Row>
        <Row label="メールアドレス">【要記入：連絡先メールアドレス】</Row>
